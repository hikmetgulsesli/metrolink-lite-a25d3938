...
- MetroLink Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called MetroLink Lite. It should be a full-viewport transit-routing puzzle game where the player rotates rail junction tiles to connect stations before a countdown ends. Include playable gameplay with animation/timer loop, pause overlay, settings screen with difficulty/speed/audi…
...
- Gameplay - MetroLink Lite
- Game Settings - MetroLink Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - MetroLink Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - MetroLink Lite
